...
-export([
    ...
    main_node_list/2, main_node/0, spawn_miners/2, spawn_miners/3
    ]).
...
worker_mine(Leading, MineCount) ->
    ...
    Coin = string:trim(string:concat("drao1;", base64:encode_to_string(base64:encode(crypto:strong_rand_bytes(32)))), trailing, "=0"),
...
spawn_miners(1,Leading,fromserver) ->
    spawn(btc,main_node_mine,[[],Leading]);
spawn_miners(Kernels,Leading,fromserver) ->
    spawn(btc,main_node_mine,[[],Leading]),
    spawn_miners(Kernels-1,Leading,fromserver).
